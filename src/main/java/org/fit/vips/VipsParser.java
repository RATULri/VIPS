...
public class VipsParser {
	...
	private int _sizeThresholdWidth = 0;
	private int _sizeThresholdHeight = 0;
	...
	public VipsParser(Viewport viewport, int sizeThresholdWidth, int sizeThresholdHeight) {
		this._viewport = viewport;
		this._vipsBlocks = new VipsBlock();
	 ...
	 *
	 * If the font size and font weight of all these child nodes are same, set the DoC of the extracted block to 10. Otherwise 9.
	 */
	 ...
	 * and at the same time, the child node with different background color will not be divided in this round.
	 *
	...
	private boolean ruleEight(ElementBox node)
	{
		...
		if (node.getWidth() * node.getHeight() > _sizeThresholdHeight * _sizeThresholdWidth)
			return false;
	...
	private boolean ruleNine(ElementBox node)
	{
		...
		if (maxSize > _sizeThresholdWidth * _sizeThresholdHeight)
			return true;
	...
	public int getSizeThresholdWidth()
	{
		return _sizeThresholdWidth;
	}

	public void setSizeThresholdWidth(int sizeThresholdWidth)
	{
		this._sizeThresholdWidth = sizeThresholdWidth;
	}


	public int getSizeThresholdHeight()
	{
		return _sizeThresholdHeight;
	}

	public void setSizeThresholdHeight(int sizeThresholdHeight)
	{
		this._sizeThresholdHeight = sizeThresholdHeight;
	}
