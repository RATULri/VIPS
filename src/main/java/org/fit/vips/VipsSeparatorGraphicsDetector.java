...
public class VipsSeparatorGraphicsDetector extends JPanel implements VipsSeparatorDetector {
	...
	/**
	 * For horizontal separators, if the differences of font properties such as font size
	 * and font weight are bigger on two sides of the separator, the weight will be increased.
	 * Moreover, the weight will be increased if the font size of the block above the separator
	 * is smaller than the font size of the block below the separator.
	 */
